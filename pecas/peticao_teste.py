...
def fun_peticao_02(p_pasta,p_autor,p_nr_processo,p_comarca,p_uf,p_cliente):
    ...
    doc.save('/home/fernandopaz/projetos/documentos/teste2.docx')
    return 'teste2.docx'



def fun_peticao_01(p_pasta,p_autor,p_nr_processo,p_comarca,p_uf,p_cliente):
    ...
    document.add_heading('EXMO SR. DR. JUIZ DE DIREITO DA COMARCA DE '+p_comarca+'/'+p_uf, 2)
    ...
    document.save('/home/fernandopaz/projetos/documentos/teste.docx')
    return 'teste.docx'
